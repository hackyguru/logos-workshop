{
  description = "ping — send pings into a logos-delivery content topic and time the round-trip to a remote ponger (core module)";
  ...
  inputs = {
    ...
    # Pinned to v0.1.1 (proven in part6-shared-color / part8-videocall).
